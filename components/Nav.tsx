...
export default function Nav() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="flex items-center gap-3">
              <a
                href="tel:7204365746"
                className="font-bold px-4 py-2 md:px-5 md:py-2.5 rounded-lg text-sm md:text-base transition-all duration-200 shadow-lg whitespace-nowrap"
          ...
          {menuOpen && (
            <div
              ...
              style={{ background: "#0a3444", borderColor: "rgba(238,166,3,0.3)" }}
            >
              {navLinks.map((link) => (
                <a
                  key={link.href}
      ...
      <div
        className="fixed bottom-0 left-0 right-0 z-50 lg:hidden py-3 px-4 flex items-center justify-center gap-3 shadow-2xl"
      ...
      >
        ...
        <span style={{ color: "#082933", opacity: 0.5 }}>|</span>
        <a
          href="#contact"
